...
% function IsConsistent=CheckOrdering(Cell,Y)
% %% This function checks if the triangulation of cell-Faces is ordered correctly 
% Sides=[1 2;
%        2 3;
%        3 1];
% IsConsistent=true;
...
% function [Cell,Faces]=CorrectCellVol(Cell,Y,Faces,Set)
% 
% Sides=[1 2;
%        2 3;
%        3 1];
