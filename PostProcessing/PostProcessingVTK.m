...
if Set.Ablation
    ...
    %Create Cell Volume
    CreateVtkVol(Y.DataOrdered,CellNoAblated,Faces,folder, '_NoAblated', TimeStep)
    CreateVtkVol(Y.DataOrdered,CellOnlyAblated,Faces,folder,'_OnlyAblated', TimeStep)
