function Set = WoundDefault(Set)
	...
	DSet.Contractility_Variability_PurseString		 = [1, 0.96, 1.087, 1.74, 2.37, 2.61, 2.487, 2.536, 2.46, 2.52, 2.606, 2.456, 2.387, 2.52, 2.31, 2.328, 2.134, 2.07, 2.055, 1.9, 1.9].^2.7;
